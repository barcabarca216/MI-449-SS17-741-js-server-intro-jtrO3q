...
var server = http.createServer(function (request, response) {
  if (request.url === '/') {
    response.end('<h1>HOME</h1>' + '<p>HOW ARE YOU THIS FINE DAY?</p>' + '<a href="/cuteness">Click here for adorable animals</a>' + '             <a href="/random-joke">Click here for hilarious jokes</a>')
  ...
  } else { response.end('<h1>This is not the page you are looking for</h1>' + '<a href="/">TO THE HOME PAGE</a>' + '<img src="https://s-media-cache-ak0.pinimg.com/originals/f8/c3/e8/f8c3e844d98cb3ca75a58806e11fe808.png" alt="goodhope">' + '<a href="/">TO THE HOME PAGE</a>') }
})
